...
ac = AutoCalc(log, pt, ht, 7, AUTO_INIT_DB, AUTO_HOLD_DB, 2, min_m=0.5, rot_gain=1.5, dynamic_scale=GPSScaleDiff())
thread_a = AutoThrustThreaded(log, tm, ac, wpm, rate=10, t_name="ThrusterCTL")
